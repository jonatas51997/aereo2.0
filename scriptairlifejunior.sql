...
CREATE TABLE IF NOT EXISTS `airlifes`.`VOO` (
  ...
  PRIMARY KEY (`idVOO`),
  INDEX `fk_VOO_AVIAO1_idx` (`AVIAO_idAVIAO` ASC) VISIBLE,
  INDEX `fk_VOO_AEROPORTO1_idx` (`idAEROPORTO_ORIGEM` ASC) VISIBLE,
  INDEX `fk_VOO_AEROPORTO2_idx` (`idAEROPORTO_DESTINO` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `airlifes`.`TICKET` (
  ...
  INDEX `fk_RESERVA_VOO1_idx` (`VOO_idVOO` ASC) VISIBLE,
  INDEX `fk_TICKET_COMPRA1_idx` (`COMPRA_idCOMPRA` ASC) VISIBLE,
  INDEX `fk_TICKET_PASSAGEIRO1_idx` (`PASSAGEIRO_idPASSAGEIRO` ASC) VISIBLE,
